...
int main (int argc, char *argv[])
{
  ...
  std::ifstream nfile ("src/ndnSIM/examples/icens-nodes-30.txt", std::ios::in);

  std::string nodeid, nodename, nodetype;
  int nodecount = 0; //number of nodes in topology
  int numOfPMUs = 4; //number of PMUs
  ...
  std::ifstream efile ("src/ndnSIM/examples/icens-edges-30.txt", std::ios::in);
...
/*
  ...
  {
        int yaxis = (rand() % 150) + 1;
        AnimationInterface::SetConstantPosition(nodes.Get(com_nodes[itr]), (itr+1)*170, yaxis);
  }
*/
  AnimationInterface::SetConstantPosition(nodes.Get(com_nodes[0]), 200, 10);
  AnimationInterface::SetConstantPosition(nodes.Get(com_nodes[1]), 150, 120);
  AnimationInterface::SetConstantPosition(nodes.Get(com_nodes[2]), 300, 70);
  AnimationInterface::SetConstantPosition(nodes.Get(com_nodes[3]), 500, 150);
  AnimationInterface::SetConstantPosition(nodes.Get(com_nodes[4]), 810, 40);
...
/*
  ...
  {
        int yaxis = (rand() % 270) + 290;
        AnimationInterface::SetConstantPosition(nodes.Get(agg_nodes[itr]), itr*100+10, yaxis);
  }
*/
  AnimationInterface::SetConstantPosition(nodes.Get(agg_nodes[0]), 100, 340);
  AnimationInterface::SetConstantPosition(nodes.Get(agg_nodes[1]), 200, 490);
  AnimationInterface::SetConstantPosition(nodes.Get(agg_nodes[2]), 300, 480);
  AnimationInterface::SetConstantPosition(nodes.Get(agg_nodes[3]), 400, 300);
  AnimationInterface::SetConstantPosition(nodes.Get(agg_nodes[4]), 500, 370);
  AnimationInterface::SetConstantPosition(nodes.Get(agg_nodes[5]), 600, 290);
  AnimationInterface::SetConstantPosition(nodes.Get(agg_nodes[6]), 700, 500);
  AnimationInterface::SetConstantPosition(nodes.Get(agg_nodes[7]), 800, 470);
  AnimationInterface::SetConstantPosition(nodes.Get(agg_nodes[8]), 850, 400);
  AnimationInterface::SetConstantPosition(nodes.Get(agg_nodes[9]), 950, 410);

  //Adding phy nodes
/*
  for(int itr = 0; itr < (int)phy_nodes.size(); itr++)
  {
        int yaxis = (rand() % 1000) + 780;
        if (yaxis > 1000) yaxis = 1000;
        AnimationInterface::SetConstantPosition(nodes.Get(phy_nodes[itr]), itr*70, yaxis);
  }
*/
  AnimationInterface::SetConstantPosition(nodes.Get(phy_nodes[0]), 10, 790);
  AnimationInterface::SetConstantPosition(nodes.Get(phy_nodes[1]), 70, 880);
  AnimationInterface::SetConstantPosition(nodes.Get(phy_nodes[2]), 130, 990);
  AnimationInterface::SetConstantPosition(nodes.Get(phy_nodes[3]), 190, 880);
  AnimationInterface::SetConstantPosition(nodes.Get(phy_nodes[4]), 250, 790);
  AnimationInterface::SetConstantPosition(nodes.Get(phy_nodes[5]), 310, 920);
  AnimationInterface::SetConstantPosition(nodes.Get(phy_nodes[6]), 370, 910);
  AnimationInterface::SetConstantPosition(nodes.Get(phy_nodes[7]), 440, 950);
  AnimationInterface::SetConstantPosition(nodes.Get(phy_nodes[8]), 500, 960);
  AnimationInterface::SetConstantPosition(nodes.Get(phy_nodes[9]), 560, 830);
  AnimationInterface::SetConstantPosition(nodes.Get(phy_nodes[10]), 620, 960);
  AnimationInterface::SetConstantPosition(nodes.Get(phy_nodes[11]), 680, 920);
  AnimationInterface::SetConstantPosition(nodes.Get(phy_nodes[12]), 740, 890);
  AnimationInterface::SetConstantPosition(nodes.Get(phy_nodes[13]), 820, 990);
  AnimationInterface::SetConstantPosition(nodes.Get(phy_nodes[14]), 990, 870);

  AnimationInterface anim("anim-ip-30nodes.xml");
