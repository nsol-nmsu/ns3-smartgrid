...
//Time::SetResolution (Time::NS);
  ...
  ApplicationContainer proApps = proHelper.Install (nodes.Get (5));
  ...
  aggHelper.SetAttribute ("RemoteAddress", AddressValue (InetSocketAddress (interfaces4.GetAddress (1), pmuMsgPort)));
  ...
  subHelper.SetAttribute ("RemoteAddress", AddressValue (InetSocketAddress (interfaces7.GetAddress (1), pmuMsgPort)));
...
*/
  ...
  Simulator::Schedule (Seconds (2),&Ipv4::SetDown,ipv4n3, 2); //bring down the second p2p interface attached on node 3
  Simulator::Schedule (Seconds (4),&Ipv4::SetUp,ipv4n3, 2);
