...
/**
 * \brief Create an application on a node. This helper is generic and developed to be used with iCenS applications
 */
class AppHelper
{
public:
  /**
   * Create AppHelper which will make life easier for people trying
   * to set up simulations on nodes.
   *
