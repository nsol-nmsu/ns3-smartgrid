...
AppHelper::Install (Ptr<Node> node) const
{
  return ApplicationContainer (InstallPriv (node));
}

ApplicationContainer
AppHelper::Install (std::string nodeName) const
{
...
ApplicationContainer
AppHelper::Install (NodeContainer c) const
{
...
Ptr<Application>
AppHelper::InstallPriv (Ptr<Node> node) const
{
